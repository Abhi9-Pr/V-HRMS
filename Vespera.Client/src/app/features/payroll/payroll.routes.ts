...
export const PAYROLL_ROUTES: Routes = [
  {
    ...
    children: [
      { path: '', redirectTo: 'runs', pathMatch: 'full' },
      {
        path: 'runs',
        loadComponent: () =>
          import('./payroll-run-wizard/payroll-run-wizard.component').then((m) => m.PayrollRunWizardComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./variance-review/variance-review.component').then((m) => m.VarianceReviewComponent),
        canActivate: [permissionGuard],
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./salary-structure-editor/salary-structure-editor.component').then(
            (m) => m.SalaryStructureEditorComponent,
          ),
        canActivate: [permissionGuard],
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./investment-declaration/investment-declaration.component').then(
            (m) => m.InvestmentDeclarationComponent,
          ),
        canActivate: [permissionGuard],
