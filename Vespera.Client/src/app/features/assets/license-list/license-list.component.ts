...
import { SoftwareLicenseDto } from '../../../core/api/generated/api-client';
...
export class LicenseListComponent implements OnInit, AfterViewInit {
  ...
  columns: DataTableColumn<SoftwareLicenseDto>[] = [
    ...
    { key: 'expiresAt', header: 'Expires', cell: (row) => (row.expiresAt ? new Date(row.expiresAt).toLocaleDateString() : '—') },
