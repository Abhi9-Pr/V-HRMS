...
public sealed class SlaPoliciesController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(CreateSlaPolicyResponse), StatusCodes.Status200OK)]
    public async Task<IActionResult> Create(
        ...
        (await _sender.Send(
            new CreateSlaPolicyCommand(
                ...
                idempotencyKey),
            cancellationToken))
            .ToActionResult(this, id => Ok(new CreateSlaPolicyResponse(id)));

    /// <response code="200">A page of SLA policies.</response>
    [HttpGet]
    [HasPermission(Permissions.Helpdesk.ManageConfiguration)]
    [ProducesResponseType(typeof(PagedResult<SlaPolicyDto>), StatusCodes.Status200OK)]
...
public sealed record CreateSlaPolicyResponse(Guid Id);
