...
public sealed class SetTodoItemUrgencyCommandHandler : IRequestHandler<SetTodoItemUrgencyCommand, Result>
{
    ...
    public SetTodoItemUrgencyCommandHandler(
    ...
    public async Task<Result> Handle(SetTodoItemUrgencyCommand request, CancellationToken cancellationToken)
    {
        ...
        todoItem.SetUrgency(request.Urgency);
