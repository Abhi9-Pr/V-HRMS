...
public class GetTicketsQueryValidatorTests
{
    ...
    {
        var query = new GetTicketsQuery(new PagedRequest(0, 20));
    ...
    {
        var query = new GetTicketsQuery(new PagedRequest(1, 101));
    ...
    {
        var query = new GetTicketsQuery(new PagedRequest(1, 20));
