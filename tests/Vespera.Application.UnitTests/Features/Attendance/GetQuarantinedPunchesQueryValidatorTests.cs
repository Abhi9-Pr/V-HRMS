...
public class GetQuarantinedPunchesQueryValidatorTests
{
    private readonly GetQuarantinedPunchesQueryValidator _validator = new();

    [Fact]
    public void Should_Have_Error_When_Page_Is_Less_Than_One()
    {
        var query = new GetQuarantinedPunchesQuery(new PagedRequest(0, 20));
    ...
    {
        var query = new GetQuarantinedPunchesQuery(new PagedRequest(1, 201));
