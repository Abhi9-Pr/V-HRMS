...
public class GetAssetsQueryValidatorTests
{
    ...
    {
        var result = _validator.TestValidate(new GetAssetsQuery(new PagedRequest(0, 20, null, false)));
    ...
    {
        var result = _validator.TestValidate(new GetAssetsQuery(new PagedRequest(1, 201, null, false)));
    ...
    {
        var result = _validator.TestValidate(new GetAssetsQuery(new PagedRequest(1, 20, null, false)));
